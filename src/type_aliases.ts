...
function getAllStudentsFromCourseAlias(course: Course, students: Student2[]): Student2[] {
    return students.filter(student => student.courses.includes(course))
}

const am2Students2: Student2[] = getAllStudentsFromCourseAlias("AM2", students2)
const tsStudents2: Student2[] = getAllStudentsFromCourseAlias("TS", students2)

console.log("Students taking FE23 - AM2", am2Students2.length)
console.log("Students taking FE23 - Typescript", tsStudents2.length)


function mailAllStudents(students: Student2[], mail: string, signature?: string){
